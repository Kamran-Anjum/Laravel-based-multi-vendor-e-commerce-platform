      ...
      <div class="row">
          <div class="col-md-12">
            <i class="fas fa-check-circle d-sm-flex justify-content-sm-center" style="color: rgb(195,83,157);font-size: 82px;margin-bottom: 10px;"></i>
              <h1 class="display-1 text-center" style="color: rgb(195,83,157);">Coming Soon!</h>
          </div>
      </div>
  </div>
</div> -->
...
.load {
  position: relative;
  overflow: hidden;
  background-color: #c452a3 !important;
    ...
    @if(session()->get('lang') == 'en')
      <div class="row setup-content" id="step-1">
        <div class="col-md-12">
          ...
          <br>
          <button class="btn btn-primary nextBtn-one pull-right" id="1" type="button" style="border:none; border-radius: 20px; font-size: medium; background-color: #c452a3 !important;">Next</button>
        </div>
      </div>
      <div class="row setup-content" id="step-2">
        <div class="col-md-12">
            ...
            <br>
            <button class="btn btn-primary prevBtn pull-left" id="2" style="border:none; border-radius: 20px; font-size: medium; background-color: #c452a3 !important;">Go Back</button>
            <button class="btn btn-primary nextBtn-two pull-right float-right" id="2" type="button" style="border:none; border-radius: 20px; font-size: medium; background-color: #c452a3 !important;">Next</button>
      ...
      <div class="row setup-content" id="step-3">
        <div class="col-md-12">
            ...
            <br>
            <button class="btn btn-primary prevBtn pull-left" id="3" type="button" style="border:none; border-radius: 20px; font-size: medium; background-color: #c452a3 !important;">Go Back</button>
            <button class="btn btn-primary nextBtn-three pull-right float-right" id="3" type="button" style="border:none; border-radius: 20px; font-size: medium; background-color: #c452a3 !important;">Next</button>     
        </div>
      </div>
      ...
      <div class="row setup-content" id="step-4">
        <div class="col-md-12">
            ...
            <br>
            <button class="btn btn-primary prevBtn pull-left" id="4" type="button" style="border:none; border-radius: 20px; font-size: medium; background-color: #c452a3 !important;">Go Back</button>
            <button class="btn btn-primary nextBtn-four pull-right float-right" id="4" type="button" style="border:none; border-radius: 20px; font-size: medium; background-color: #c452a3 !important;">Next</button>
      ...
      <div class="row setup-content" id="step-5">
        <div class="col-md-12">
           ...
           <div class="form-group md-form">
            ...
            <br>
            <button class="btn btn-primary prevBtn pull-left" id="5" type="button" style="border:none; border-radius: 20px; font-size: medium; background-color: #c452a3 !important;">Go Back</button>
            <button class="btn btn-primary nextBtn-five pull-right float-right" id="5" type="button" style="border:none; border-radius: 20px; font-size: medium; background-color: #c452a3 !important;">Next</button>
      ...
      <div class="row setup-content" id="step-6">
        <div class="col-md-12">
            ...
            <br>     
            <button class="btn btn-primary prevBtn pull-left" id="6" style="border:none; border-radius: 20px; font-size: medium; background-color: #c452a3 !important;">Go Back</button>
            <button class="btn btn-success float-right btn-submit" id="6" type="submit" style="border:none; border-radius: 20px; font-size: medium; background-color: #c452a3 !important;">Submit</button>
    ...
    @elseif(session()->get('lang') == 'ar')
      <div class="row setup-content" id="step-1">
        <div class="col-md-12">
          ...
          <br>
          <button class="btn btn-primary nextBtn-one pull-right" id="1" type="button" style="border:none; border-radius: 20px; font-size: medium; background-color: #c452a3 !important;">التالي</button>
        </div>
      </div>
      <div class="row setup-content" id="step-2">
        <div class="col-md-12">
            ...
            <br>
            <button class="btn btn-primary prevBtn pull-left" id="2" style="border:none; border-radius: 20px; font-size: medium; background-color: #c452a3 !important;">عد</button>
            <button class="btn btn-primary nextBtn-two pull-right float-right" id="2" type="button" style="border:none; border-radius: 20px; font-size: medium; background-color: #c452a3 !important;">التالي</button>
      ...
      <div class="row setup-content" id="step-3">
        <div class="col-md-12">
            ...
            <br>
            <button class="btn btn-primary prevBtn pull-left" id="3" type="button" style="border:none; border-radius: 20px; font-size: medium; background-color: #c452a3 !important;">عد</button>
            <button class="btn btn-primary nextBtn-three pull-right float-right" id="3" type="button" style="border:none; border-radius: 20px; font-size: medium; background-color: #c452a3 !important;">التالي</button>     
        </div>
      </div>
      ...
      <div class="row setup-content" id="step-4">
        <div class="col-md-12">
            ...
            <br>
            <button class="btn btn-primary prevBtn pull-left" id="4" type="button" style="border:none; border-radius: 20px; font-size: medium; background-color: #c452a3 !important;">عد</button>
            <button class="btn btn-primary nextBtn-four pull-right float-right" id="4" type="button" style="border:none; border-radius: 20px; font-size: medium; background-color: #c452a3 !important;">التالي</button>
      ...
      <div class="row setup-content" id="step-5">
        <div class="col-md-12">
           ...
           <div class="form-group md-form">
            ...
            <br>
            <button class="btn btn-primary prevBtn pull-left" id="5" type="button" style="border:none; border-radius: 20px; font-size: medium; background-color: #c452a3 !important;">عد</button>
            <button class="btn btn-primary nextBtn-five pull-right float-right" id="5" type="button" style="border:none; border-radius: 20px; font-size: medium; background-color: #c452a3 !important;">التالي</button>
      ...
      <div class="row setup-content" id="step-6">
        <div class="col-md-12">
            ...
            <br>     
            <button class="btn btn-primary prevBtn pull-left" id="6" style="border:none; border-radius: 20px; font-size: medium; background-color: #c452a3 !important;">عد</button>
            <button class="btn btn-success btn-submit float-right" id="6" type="submit" style="border:none; border-radius: 20px; font-size: medium; background-color: #c452a3 !important;">يقدم</button>
