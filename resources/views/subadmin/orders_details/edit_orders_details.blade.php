                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/subadmin/edit-order-detail/'.$orderdetails->id) }}" name="edit_order_detail" id="edit_order" novalidate="novalidate">
                                {{ csrf_field() }}
{{--{!! dd($orderdetails) !!}--}}
