                  ...
                  <td class="center">
                    <div>
                      @if($viewstore->isActive == 0) 
                        <a href="{{ url('/subadmin/active-vendor/'.$viewstore->user_id) }}" class="btn btn-success btn-mini" style="margin:1px;">Activate</a>
                      @else 
                        <a href="{{ url('/subadmin/deactive-vendor/'.$viewstore->user_id) }}" class="btn btn btn-mini" style="margin:1px;">De-Activate</a>
                      @endif

                      <a href="{{ url('/subadmin/view-vendor-privileges/'.$viewstore->user_id ) }}" class="btn btn-info btn-mini">Privileges</a>
                    </div>
                    <div>
                      <a href="{{ url('/subadmin/vendor-details/'.$viewstore->user_id) }}" class="btn btn-primary btn-mini" style="margin:1px;">View Details</a>

                      <a class="btn btn-danger btn-mini sa-confirm-delete" param-id="{{ $viewstore->user_id }}" param-route="delete-vendor" param-user="subadmin" href="javascript:">Delete</a>
                    </div>
                  </td>
                </tr>
