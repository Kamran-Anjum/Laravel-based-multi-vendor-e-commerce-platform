                                ...
                                @foreach($orders as $order)
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td class="center" style="text-align:left;">
                                            <a href="{{ url('/subadmin/order-detail/'.$order->id ) }}" style="margin:2px 0px;" class="btn btn-primary btn-mini">Detail</a>
                                            <a href="#myModal{{ $order->id }}" data-toggle="modal" style="margin:2px 0px;" class="btn btn-success btn-mini">View</a>
                                            <a href="{{ url('/subadmin/edit-order/'.$order->id ) }}" style="margin:2px 0px;" class="btn btn-info btn-mini">Edit</a>
                                            <a style="margin:2px 0px;" class="btn btn-danger btn-mini sa-confirm-delete" param-id="{{ $order->id }}" param-route="delete-order" param-user="subadmin" href="javascript:">Delete</a>
                                        </td>
