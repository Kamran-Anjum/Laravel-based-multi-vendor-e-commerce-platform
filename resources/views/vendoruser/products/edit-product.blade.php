...
<div id="content">
  ...
  <div class="container-fluid"><hr>
    <div class="row-fluid">
      <div class="span12">
        <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/vendoruser/edit-product/'.$product_trans->id ) }}" name="edit_product" id="edit_product" novalidate="novalidate"> {{ csrf_field() }}
              ...
              <div class="widget-content nopadding">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    ...
                    <img style="width: 50px; height: 50px;" src="{{ asset('/images/backend_images/products/en/small/'.$product_trans->image) }}"> | <a class="btn btn-danger btn-mini sa-confirm-delete" param-id="{{ $product_trans->id }}" param-route="delete-product-image" param-user="vendoruser" href="javascript:">Delete</a>
                    @endif
                  </div>
                </div>
                ...
                @foreach($en_product_details as $galleryimage)
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      ...
                      <img style="width: 50px; height: 50px;" src="{{ asset('/images/backend_images/products/en/small/'.$galleryimage->image) }}"> | <a class="btn btn-danger btn-mini sa-confirm-delete" param-id="{{ $galleryimage->id }}" param-route="delete-product-galaryimage" param-user="vendoruser" href="javascript:">Delete</a>
                      @endif
                    </div>
                  </div>
                @endforeach
              ...
              <div class="widget-content nopadding">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    ...
                    <input type="hidden" name="current_image" value="{{ $product_trans->image }}">
                    @if(!empty( $product_trans->image ))
                    <img style="width: 50px; height: 50px;" src="{{ asset('/images/backend_images/products/ar/small/'.$product_trans->image) }}"> | <a class="btn btn-danger btn-mini sa-confirm-delete" param-id="{{ $product_trans->id }}" param-route="delete-product-image" param-user="vendoruser" href="javascript:">Delete</a>
                    @endif
                  </div>
                </div>
                ...
                @foreach($ar_product_details as $galleryimage)
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      ...
                      <input type="hidden" name="current_id<?php echo $count;?>" value="{{ $galleryimage->id }}">
                      @if(!empty( $galleryimage->image ))
                      <img style="width: 50px; height: 50px;" src="{{ asset('/images/backend_images/products/ar/small/'.$galleryimage->image) }}"> | <a class="btn btn-danger btn-mini sa-confirm-delete" param-id="{{ $galleryimage->id }}" param-route="delete-product-galaryimage" param-user="vendoruser" href="javascript:">Delete</a>
                      @endif
                    </div>
                  </div>
                @endforeach
