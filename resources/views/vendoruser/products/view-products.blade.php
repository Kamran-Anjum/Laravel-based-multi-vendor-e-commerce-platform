        ...
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            ...
            <h5 style="float: right; margin: 0; padding: 0 22px 0 0;">
              Language : <a href="{{ url('/vendoruser/view-en-products' ) }}"><button style="height: 36px; width: 43px;" type="button" class="btn btn-info">En</button></a> &nbsp; <a href="{{ url('/vendoruser/view-ar-products' ) }}"><button style="height: 36px; width: 43px;" type="button" class="btn btn-info">Ar</button></a>
            </h5>
          </div>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">
                    <div style="width: 150px">
                      ...
                      <a href="{{ url('/vendoruser/edit-product/'.$product->id ) }}" class="btn btn-primary btn-mini">Edit</a>
                      <a class="btn btn-danger btn-mini sa-confirm-delete" param-id="{{ $product->id }}" param-route="delete-product" param-user="vendoruser" href="javascript:">Delete</a>
                    </div>
                    <p><p/>
                    <div style="width: 150px">
                      <a style="padding: 0 35px;" href="{{ url('/vendoruser/view-product-cities/'.$product->product_id ) }}" class="btn btn-info btn-mini">View Cities</a>
                    </div>
                  </td>
                </tr>
