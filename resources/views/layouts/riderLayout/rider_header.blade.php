Header-part-->
<div id="header">
  <h1><a href="{{ url('/rider/dashboard') }}">Matrix Admin</a></h1>
</div>
<!--close-Header-part-->
...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    <li class=""><a title="" href="{{ url('/rider/settings') }}"><i class="icon icon-cog"></i> <span class="text">Settings</span></a></li>
    <li class=""><a title="" href="{{ url('/rider/logout') }}"><i class="icon icon-share-alt"></i> <span class="text">Logout</span></a></li>
  </ul>
</div>
