...
@section('content')
    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Orders</a> <a href="#" class="current">View Delivered Orders</a> </div>
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td class="center" style="text-align:left;">
                                            ...
                                            @if($order->status_id == 3)
                                              <a href="{{ url('/rider/order-accepted/'.$order->id ) }}" style="margin:2px 0px;" class="btn btn-success btn-mini">Accept</a>
                                            @elseif($order->status_id == 4 && $order->rider_id == Auth::user()->id)
                                              <a href="{{ url('/rider/order-delivered/'.$order->id ) }}" style="margin:2px 0px;" class="btn btn-success btn-mini">Deliverd</a>
                                              <a href="{{ url('/rider/order-cancel/'.$order->id ) }}" style="margin:2px 0px;" class="btn btn-danger btn-mini">Cancel</a>
