...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{ url('/rider/dashboard') }}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{ url('/rider/settings') }}" title="Go to Setting" class="tip-bottom">Setting</a> <a href="#" class="current">Update Profile</a> </div>
                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/rider/update-profile/') }}" name="add_sub_admin" id="add_sub_admin" novalidate="novalidate">
                                {{ csrf_field() }}
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select name="isActive" id="city_id" disabled="">
                                            @if($rider->isActive == 0)
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="select2 form-control custom-select admin_privilege_country_class" name="country_id" id="country_id" disabled="">
                                            {!! $countries_dropdown !!}
                                        </select>
                                    </div>
                                </div>
