...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> 
      ...
      <a href="#" class="current">Store Details</a> 
    </div>
    <h1>Store Details</h1>
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="" action="" > 
              ...
              <div class="control-group">
                ...
                <label class="control-label">{{ $storeDetail->country }}</label>
              </div>
              <div class="control-group">
                <label class="control-label"><strong>City:</strong></label>
                <label class="control-label">{{ $storeDetail->city }}</label>
              </div>
              <div class="control-group">
              ...
              <div class="control-group">
                ...
                <label class="control-label">
                  <img src=" {{ asset('/vendor_docs/'.$storeDetail->trade_license ) }}" alt="Click To DOWNLOAD" height="75px" width="75px" onclick="window.open(this.src)">
                </label>
              </div>
              <div class="control-group">
                <label class="control-label"><strong>National ID:</strong></label>
                <label class="control-label">
                  <img src=" {{ asset('/vendor_docs/'.$storeDetail->national_id ) }}" alt="Click To DOWNLOAD" height="75px" width="75px" onclick="window.open(this.src)">
                </label>
              </div>
              <div class="control-group">
              ...
              <div class="control-group">
                ...
                <label class="control-label">
                  <img src=" {{ asset('/vendor_docs/'.$storeDetail->tax_reg_certificate ) }}" alt="Click To DOWNLOAD" height="75px" width="75px" onclick="window.open(this.src)">
                </label>
              </div>
              <div class="control-group">
              ...
              <div class="control-group">
                ...
                <label class="control-label">{{ $storeDetail->currency }}</label>
              </div>
              <div class="control-group">
                <label class="control-label"><strong>Bank Stemped Document:</strong></label>
                <label class="control-label">
                  <img src=" {{ asset('/vendor_docs/'.$storeDetail->stemped_doc ) }}" alt="Click To DOWNLOAD" height="75px" width="75px" onclick="window.open(this.src)">
                </label>
              </div>
              <div class="control-group">
