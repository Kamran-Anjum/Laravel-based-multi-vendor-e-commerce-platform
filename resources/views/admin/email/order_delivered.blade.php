                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p15t es-p15b" align="center">
                                                                <div class="esd-text">
                                                                    <h2 style="color: #242424;"><span style="font-size:30px;"><strong>Your order is delivered. </strong></span></h2>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text es-p10l" align="center">
                                                                <p style="color: rgb(36, 36, 36);">Hi {{$u_name}}, we've delivered your  order # {{$order_no}} <br></p>

                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-button es-p15t es-p15b es-p10r es-p10l" align="center"> <span class="es-button-border" style="border-radius: 20px; background: rgb(25, 25, 25) none repeat scroll 0% 0%; border-style: solid; border-color: rgb(44, 181, 67); border-width: 0px;"> <a href="https://google.com/" class="es-button" target="_blank" style="border-radius: 20px; font-family: lucida sans unicode,lucida grande,sans-serif; font-weight: normal; font-size: 18px; border-width: 10px 35px; background: rgb(25, 25, 25) none repeat scroll 0% 0%; border-color: rgb(25, 25, 25); color: rgb(255, 255, 255);">View your order details</a> </span> </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text" align="center">
                                                                <h2 style="color: rgb(25, 25, 25);">Items ordered<br></h2>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-image" align="center">
                                                                <a target="_blank"> <img class="adapt-img" src="{{url('\images\backend_images\product_galary\small')}}" alt width="103"> </a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text" align="left">
                                                                <p><span style="font-size:16px;"><strong style="line-height: 150%;">{{$p_name}}</strong></span></p>
                                                                {{--                                                                <p>Memory: 32GB</p>--}}
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p20t" align="left">
                                                                <p><span style="font-size:15px;"><strong style="line-height: 150%;">Item Price:</strong> ${{$unit_price}}</span></p>
                                                            ...
                                                            <td class="esd-block-text es-p15b" align="center">
                                                                <table class="cke_show_border" width="240" height="101" cellspacing="1" cellpadding="1" border="0">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: right;"><span style="font-size: 18px; line-height: 200%;"><strong>${{$grand_total}}</strong></span><br></td>
                                                                    </tr>
                                                                    </tbody>
                                                                </table>
                                                            </td>
                                            ...
                                            <tr>
                                                <td class="esd-container-frame" width="580" valign="top" align="center">
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text" align="center">
                                                                <h2 style="color: rgb(25, 25, 25);">Order & shipping info</h2>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p10t es-p10b" align="left">
                                                                <h3 style="color: rgb(36, 36, 36);">Order details</h3>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text" align="left">
                                            ...
                                            <tr>
                                                <td class="esd-container-frame" width="270" align="left">
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p10t es-p10b" align="left">
                                                                <h3 style="color: rgb(36, 36, 36);">Shipping Address</h3>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text" align="left">
                                                                <p>{{$shipToAddress}}<strong></strong></p>
                                            ...
                                            <tr>
                                                <td class="es-m-p20b esd-container-frame" width="270" align="left">
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text" align="center">
                                                                <p style="line-height: 150%; color: rgb(36, 36, 36);">Call (009) 111-111 or <a target="_blank">visit us online</a></p>
                                                                <p style="line-height: 150%; color: rgb(36, 36, 36);">for expert assistance.</p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                            ...
                                            <tr>
                                                <td class="esd-container-frame" width="270" align="left">
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text" align="center">
                                                                <p style="line-height: 150%; color: rgb(36, 36, 36);">Your satisfaction is 100% guaranteed.</p>
                                                                <p style="line-height: 150%; color: rgb(36, 36, 36);">See our <a target="_blank">Returns and Exchanges policy.</a></p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                ...
                                <tr>
                                    <td class="esd-structure es-p20" esd-general-paddings-checked="false" align="left">
                                        <table width="100%" cellspacing="0" cellpadding="0">
                                            <tbody>
                                            <tr>
                                                <td class="esd-container-frame" width="560" valign="top" align="center" esd-custom-block-id="43297">
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        <tbody>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p20t es-p20b" align="center">
                                                                <p style="line-height: 120%;">Lillac, Inc.<br></p>
                                                                <p style="line-height: 120%;">62 N. Gilbert, CA 99999</p>
                                                                <p style="line-height: 120%;">+92 123 000 000</p>
                                                                <p style="line-height: 120%;">contact@lilacexpress.com</p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
