...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Product Units</a> <a href="#" class="current">Add Product Unit</a> </div>
    <h1>Product Units</h1>
  </div>
  <style>
  ...
  <div class="container-fluid"><hr>
    <div class="row-fluid">
      <div class="span12">
        <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/admin/add-prod-unit') }}" name="add_product_unit" id="add_product_unit" novalidate="novalidate"> {{ csrf_field() }}
          ...
          <div id="sub_both" style="text-align: center;" class="form-actions">
            <input style="padding: 5px 50px; font-size: 15px;" type="submit" value="Add Product Unit / أضف وحدة المنتج" class="btn btn-success">
          </div>
          <div id="sub_en" style="text-align: left; display: none;" class="form-actions">
            <input style="padding: 5px 50px; font-size: 15px;" type="submit" value="Add Product Unit" class="btn btn-success">
          </div>
          <div id="sub_ar" style="text-align: right; display: none;" class="form-actions">
            <input style="padding: 5px 50px; font-size: 15px;" type="submit" value="أضف وحدة المنتج" class="btn btn-success">
          </div>
        </form>
      </div>
    </div>
