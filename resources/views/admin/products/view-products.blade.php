                ...
                <tr class="gradeX">
                  ...
                  <td class="center">
                    <div style="width: 150px">
                      ...
                      <a class="btn btn-danger btn-mini sa-confirm-delete" param-id="{{ $product->id }}" param-route="delete-product" param-user="admin" href="javascript:">Delete</a>
                    </div>
                    <p><p/>
                    <div style="width: 150px">
                      <a style="padding: 0 35px;" href="{{ url('/admin/view-product-cities/'.$product->product_id ) }}" class="btn btn-info btn-mini">View Cities</a>
                    </div>
                  </td>
                </tr>
