...
<link rel="icon" type="image/png" sizes="16x16" href="{{ asset('images/frontend_images/lilac2express-logo.png') }}">
    ...
    <body>
        ...
        @endif
            <form id="loginform" method="post" class="form-vertical" action="{{ url('admin') }}">{{ csrf_field() }}
                ...
                <div class="form-actions">
                    <span class="pull-left"><a href="{{ url('admin/lost-password') }}" class=" btn btn-info">Lost password?</a></span>
