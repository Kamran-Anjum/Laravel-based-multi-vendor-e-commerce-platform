...
@section('content')
    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Rider</a> <a href="#" class="current">View Rider Orders</a> </div>
            <h1>Rider Orders</h1>
