                              ...
                              .table th, .table td {
                                ...
                                @foreach($orders as $order)
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td><center>{{ $order->shipToAddress }}</center></td>
                                        ...
                                        <td class="center" style="text-align:left;">
                                            <a href="{{ url('/admin/order-detail/'.$order->id ) }}" style="margin:2px 0px;" class="btn btn-primary btn-mini">Detail</a>
                                            <a href="#myModal{{ $order->id }}" data-toggle="modal" style="margin:2px 0px;" class="btn btn-success btn-mini">View</a>
                                            <a href="{{ url('/admin/edit-order/'.$order->id ) }}" style="margin:2px 0px;" class="btn btn-info btn-mini">Edit</a>
                                            <a style="margin:2px 0px;" class="btn btn-danger btn-mini sa-confirm-delete" param-id="{{ $order->id }}" param-route="delete-order" param-user="admin" href="javascript:">Delete</a>
                                        </td>
                                    ...
                                    <div id="myModal{{ $order->id }}" class="modal hide">
                                        ...
                                        <div class="modal-body">
                                          <style>
                                            ...
                                            <label> <strong>VAT ({{ $order->vat_value }}%):</strong> {{ $order->vat_amount  }}</label>
