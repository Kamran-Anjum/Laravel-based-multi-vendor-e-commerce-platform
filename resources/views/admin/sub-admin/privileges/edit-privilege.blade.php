...
@section('content')
    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="{{ url('/admin/dashboard') }}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a style="cursor: default;" href="javascript:void(0)" class="current">Edit Privilege</a> </div>
            <h1>Privilege</h1>
                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/admin/edit-sub-admin-privilege/'.$privilege->id) }}" name="edit_sub_admin" id="edit_sub_admin" novalidate="novalidate">
                                {{ csrf_field() }}
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select id="isChat" name="isChat" class="Active">
                                            <option value="0" @if($privilege->chat_supports == 0) selected="true" @endif > No </option>
                                            <option value="1" @if($privilege->chat_supports == 1) selected="true" @endif> Yes </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select id="isVendor" name="isVendor" class="Active">
                                            <option value="0" @if($privilege->vendors == 0) selected="true" @endif > No </option>
                                            <option value="1" @if($privilege->vendors == 1) selected="true" @endif> Yes </option>
                                        </select>
                                    </div>
                                </div>
