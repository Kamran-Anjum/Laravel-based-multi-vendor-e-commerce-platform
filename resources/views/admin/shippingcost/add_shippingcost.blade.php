...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Delivery Zone </a> <a href="#" class="current">Add Delivery Zone </a> </div>
    <h1>Delivery Zone </h1>
  </div>
      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="{{ url('/admin/add-zone/') }}" name="edit_shippingcost" id="edit_shippingcost" novalidate="novalidate"> {{ csrf_field() }}
              <style>
              ...
              <!-- <div class="control-group">
                ...
                <div class="controls">
                  <input type="number" name="shippingCost" id="shippingCost"  required="">
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="number" name="amountLimit" id="amountLimit"  required="">
                </div>
              </div> -->
              ...
              <div class="form-actions">
                <input type="submit" value="Add Zone " class="btn btn-success">
              </div>
            </form>
          </div>
        </div>
