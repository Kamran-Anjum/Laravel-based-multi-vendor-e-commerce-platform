...
@section('content')
    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Countries</a> <a href="#" class="current">Add Countries</a> </div>
            <h1>Products</h1>
                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/admin/add-country') }}" name="add_country" id="add_country" novalidate="novalidate"> {{ csrf_field() }}
                                <style>
