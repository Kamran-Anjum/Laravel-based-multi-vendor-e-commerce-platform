...
<div id="content">
  <div id="content-header">
    ...
    <h1>
        <div class="button-group">
            <a href="{{ url('vendor/view-product-cities/'.$productId) }}"><button style="margin-top: -45px" type="button" class="btn btn-mini waves-effect waves-light btn-info">&#60; Back</button></a>
        </div>
    </h1>
  </div>
  <style>
  ...
  <div class="container-fluid"><hr>
    <div class="row-fluid">
      <div class="span12">
        <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/vendor/add-product-city/'.$productId) }}" name="add_product_city" id="add_product_city" novalidate="novalidate"> {{ csrf_field() }}
          <div class="widget-box">
            <div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span>
              <h5>Add City</h5>
              <button style="height: 36px;" type="button" class="btn btn-info btn-lg pull-right vendorcountryclass_addRow" id="VendorCountryCity_btn_add">
            ...
            <div class="widget-content nopadding">
              <div>
                ...
                <table id="VendorCountryCity_MultiRecGrid" class="table table-bordered">
                    ...
                    <tbody>
                        <tr id="dynamic_row">
                            ...
                            <td>
                                <select class="vendor_product_country_class" name="countryid_{{$sno}}" id="countryid_{{$sno}}">
                                  {!! $countries_dropdown !!}
                                </select>
                            </td>
                            <td>
