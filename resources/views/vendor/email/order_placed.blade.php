                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p15t es-p15b" align="center">
                                                                <div class="esd-text">
                                                                    <h2 style="color: #242424;"><span style="font-size:30px;"><strong>Your order is confirmed. </strong></span></h2>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text es-p10l" align="center">
                                                                <p style="color: rgb(36, 36, 36);">Hi {{$u_name}}, we've received order {{$order_no}} and are working on it now.<br></p>
                                                                <p style="color: rgb(36, 36, 36);">We'll email you an update when we've shipped it.<br></p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-image" align="center">
                                                                <a target="_blank"> <img class="adapt-img" src="https://tlr.stripocdn.email/content/guids/CABINET_94315d81e0d4fd69c43a9dfb4e4c237f/images/29841502094430830.png" alt width="103"> </a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
