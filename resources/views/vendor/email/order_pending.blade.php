...
<head>
    ...
    <title>Your order is pending</title>
    <!--[if (mso 16)]>
    <style type="text/css">
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p15t es-p15b" align="center">
                                                                <div class="esd-text">
                                                                    <h2 style="color: #242424;"><span style="font-size:30px;"><strong>Your order is pending. </strong></span></h2>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-image" align="center">
                                                                <a target="_blank"> <img class="adapt-img" src="" alt width="103"> </a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
