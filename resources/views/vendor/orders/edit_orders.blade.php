...
{{--{!! dd($orderDetails->u_name) !!}--}}
                        <div class="widget-content nopadding">

                            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/vendor/edit-order/'.$orderDetail->id) }}"  novalidate="novalidate">
                              <style>
                                ...
                                <div class="control-group">
                                   ...
                                   @foreach($status as $st)
                                        @if($st->id == $orderDetail->s_id)
                                        <label class="control-label">{{$st->name}}</label>
                                        @endif  
                                   @endforeach
                                   <!-- <div class="controls">
                                       <select class="status" name="status_id" id="status_id"style="width: 220px;">
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/vendor/edit-order/'.$orderDetail->id) }}"  novalidate="novalidate">
                                            ...
                                            <div class="">
                                               <div class="">
                                                   <select class="status" name="status_id" id="status_id">
                                                       @foreach($status as $st)
