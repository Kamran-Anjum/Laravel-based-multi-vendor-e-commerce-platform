...
class ProductController extends Controller
{
    public function viewProducts(){
        ...
        return view('vendor.products.view-products')->with(compact('products','categories','brands','product_units','price_units'));
    }
    ...
    public function addProduct(Request $request){
            ...
            if($product){
                ...
                if($flag == true){
                    if($data['lang_dropdown'] == "en"){
                        ...
                        $en_product_trans->created_for = Auth::user()->id;
                    ...
                    if($data['lang_dropdown'] == "ar"){
                        ...
                        $ar_product_trans->created_for = Auth::user()->id;
    	...
    	return view('vendor.products.add-product')->with(compact('countries_dropdown','en_categories_dropdown','ar_categories_dropdown','en_brand_dropdown','ar_brand_dropdown','en_productunit_dropdown','ar_productunit_dropdown','en_priceunit_dropdown','ar_priceunit_dropdown'));
    }
    ...
    public function editProduct(Request $request, $id =null){
        if($request->isMethod('post')){
            ...
            return redirect('/vendor/view-products')->with('flash_message_success','Product has been Updated Successfully!');
        }
        ...
        return view('vendor.products.edit-product')->with(compact('product_trans','en_product_details','ar_product_details','en_categories_dropdown','ar_categories_dropdown','en_brand_dropdown','ar_brand_dropdown','en_productunit_dropdown','ar_productunit_dropdown','en_priceunit_dropdown','ar_priceunit_dropdown'));
    }
...
//         return view('vendor.products.search')->with(compact('countries'));
