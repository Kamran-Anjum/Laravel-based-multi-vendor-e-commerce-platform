...
class ProductCityController extends Controller
{
    public function viewProductCities($productId = null){
        ...
        return view('vendor.products.cities.view-cities')->with(compact('cities','productId'));
    }
    ...
    public function addProductCity(Request $request, $productId = null){
    	if($request->isMethod('post')){
            ...
            if($productId){
                ...
                return redirect('/vendor/view-product-cities/'.$productId)->with('flash_message_success','City Added Successfully!');
            }
        }
        ...
        return view('vendor.products.cities.add-city')->with(compact('countries_dropdown','productId'));
    }
