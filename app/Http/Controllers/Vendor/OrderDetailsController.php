...
//dd($orderdetails);
        ...
        return view('vendor.orders_details.view_orders_details')->with(compact('orderdetails', 'orders', 'rider'));
    }
...
//            dd($request);
        ...
        $orderdetails->save();
        return view('vendor.orders_details.edit_orders_details')->with(compact('orderdetails'));
    }
}
