...
use App\SubAdminPrivilege;
use App\SubAdminActiveCity;
use App\Brand;
use App\Product;
...
class ProductsController extends Controller
{
    public function addProduct(Request $request){
    	...
    	return view('subadmin.products.add_product')->with(compact('countries_dropdown','categories_dropdown','brands_dropdown','productunit_dropdown','priceunits_dropdown'));
    }
    ...
    public function editProduct(Request $request, $id =null){
       ...
       $countries = DB::table('sub_admin_privileges as sap')
        ...
        ->where(['sap.user_id'=> Auth::user()->id])
        ->where(['sap.country_id'=> $productDetails->country_id])
        ->where(['ci.isActive'=> 1])
        ...
        return view('subadmin.products.edit_product')->with(compact('productDetails','categories_dropdown','productImages','brands_dropdown','productunit_dropdown','priceunits_dropdown','countries','cities'));
    }
    public function viewProducts(){
        $subadmin_active_city = SubAdminActiveCity::where(['user_id'=>Auth::user()->id])->first();
        $active_city = $subadmin_active_city->city_id;
    	...
    	return view('subadmin.products.view_products')->with(compact('products'));
    }
