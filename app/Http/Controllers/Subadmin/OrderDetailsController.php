...
//dd($orderdetails);
        ...
        return view('subadmin.orders_details.view_orders_details')->with(compact('orderdetails', 'orders', 'rider'));
    }
...
//            dd($request);
        ...
        $orderdetails->save();
        return view('subadmin.orders_details.edit_orders_details')->with(compact('orderdetails'));
    }
}
