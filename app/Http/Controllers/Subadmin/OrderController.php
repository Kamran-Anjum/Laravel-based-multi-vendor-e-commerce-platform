...
//            dd($order);
            ...
            return redirect('/subadmin/view-order')->with('flash_message_success','Order Added Successfully!');
        }
        return view('subadmin.orders.add_orders');
    ...
    public function viewOrder(){
        ...
        ->where(['o.city_id'=>session()->get('SubAdminActiveCity')])
        ...
        return view('subadmin.orders.view_orders')->with(compact('orders','orderdetails'));
    }
...
//            $orderDetails->save();
            $status = DB::table('status')->where(['deleted_at'=>NULL])->get();
        return view('subadmin.orders.edit_orders')->with(compact('orderDetail','orderDetails','status'));
