...
class ProductsController extends Controller
{
    ...
    public function addProduct(Request $request){
    	...
    	return view('admin.products.add_product')->with(compact('categories_dropdown','brands_dropdown','productunit_dropdown','priceunits_dropdown'));
    }
    public function editProduct(Request $request, $id =null){
        ...
        if($request->isMethod('post')){
            ...
            Product::where(['id'=>$id])->update(['category_id'=>$data['category_id'],'name'=>$data['name'],'code'=>$data['code'],'price'=>$data['price'],'saleprice'=>$data['saleprice'],'discount'=>$data['discount'],'color'=>$data['color'],'height'=>$data['height'],'width'=>$data['width'],'weight'=>$data['weight'],'description'=>$data['description'],'long_description'=>$data['long_description'], 'image'=>$filename,'isHotDeal'=>$ishotdeal,'isTopOffer'=>$istopoffer,'isFeatured'=>$isfeatured,'product_unit_id'=>$data['productunit_id'],'brand_id'=>$data['brand_id'],'quantity'=>$data['quantity'], 'priceunit_id'=>$data['priceunit_id']]);
        ...
        return view('admin.products.edit_product')->with(compact('productDetails','categories_dropdown','productImages','brands_dropdown','productunit_dropdown','priceunits_dropdown'));
    }
