...
class RiderController extends Controller
{
    public function viewRider(){
    	...
    	return view('admin.rider.view-rider')->with(compact('riders'));
    ...
    public function viewRiderOrder($id){
        ...
        return view('admin.rider.view-rider-orders')->with(compact('orders','orderdetails'));
    ...
    public function viewRiderDetail($id){
        ...
        return view('admin.rider.view-rider-detail')->with(compact('rider'));
    ...
    public function addRider(Request $request){
        ...
        if($request->isMethod('post')){
            ...
            else
            {
                ...
                return redirect('admin/view-rider')->with('flash_message_success','Rider Added successfully!');
            }
        }
        else
        {
            ...
            return view('admin.rider.create-rider')->with(compact('countries_dropdown'));
        }
    }
    ...
    public function editRider(Request $request, $id = null){
        ...
        if($request->isMethod('post')){
        	...
        	return redirect('/admin/view-rider')->with('flash_message_success','Rider has been Updated Successfully!'); 
        }
        ...
        return view('admin.rider.edit-rider')->with(compact('countries_dropdown','rider', 'city'));
    }
